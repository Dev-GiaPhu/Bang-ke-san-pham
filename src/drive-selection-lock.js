/* GP Statistical — repair each Drive identity once, then lock only the folder identity. */
(function(){
  const STORE='ventek-design-tracker-v2',ASSET=/\.(png|jpe?g|webp|gif|bmp|tiff?|svg|pdf|ai|psd|eps|indd|zip)$/i,IMG=/\.(png|jpe?g|webp|gif|bmp|tiff?|svg)$/i;
